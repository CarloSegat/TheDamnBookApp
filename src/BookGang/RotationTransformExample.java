...
public class RotationTransformExample extends Application {
  @Override public void start(final Stage stage) throws Exception {
    ...
    rotationTransform.pivotXProperty().set(0);
    rotationTransform.pivotYProperty().set(0);
    rotationTransform.pivotZProperty().set(0);
...
//    rotationTransform.pivotZProperty().bind(zPivotSlider.valueProperty());
    ...
    vBox.getChildren().addAll(xPivotControl, yPivotControl, zPivotControl, axisControl);
